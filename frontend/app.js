...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function addParticipant(name = '') {
        ...
        // Обновляем список потребителей в товарах
        updateItemsConsumers();
    }
    ...
    function addItem(name = '', price = '', quantity = '') {
        ...
        updateTotal();
        updateItemsConsumers(); // Обновляем список участников
    }
    ...
    // Обновление списка "Кто ел" для каждого товара
    ...
    document.getElementById('calculate-btn').addEventListener('click', () => {
        ...
        const sumWithoutTip = Object.values(participantSums).reduce((a, b) => a + b, 0);
        if (sumWithoutTip > 0) {
    ...
    document.getElementById('scan-qr').addEventListener('click', () => {
        alert('Функция сканирования временно недоступна. Используйте ручной ввод.');
    });
    ...
    // === Инициализация: добавим одного участника и один товар по умолчанию ===
    addParticipant();
    addItem();
});
